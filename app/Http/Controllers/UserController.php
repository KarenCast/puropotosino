...
class UserController extends Controller
{
    ...
    public function enviarC(Request $request)
    {
        set_time_limit(0);
    ...
    public function etapacero(Request $request)
    {
        set_time_limit(0);
        // $emp = Empresas::where('ID_empresa', $request->id)->first();
        $contacto = Contacto::where('ID_empresa', $request->id)->first();
    ...
    public function etapauno_old(Request $request)
    {
        set_time_limit(0);
    ...
    public function etapauno(Request $request)
    {
        set_time_limit(0);
        $name = session('ID_e');
    ...
    public function etapados(Request $request)
    {
        set_time_limit(0);
    ...
    public function etapatres(Request $request)
    {
    ...
    public function etapacuatro(Request $request)
    {
        set_time_limit(0);
        $name = session('ID_e');
        $carpeta = storage_path();
    ...
    public function etapacinco(Request $request)
    {
        set_time_limit(0);
        $name = session('ID_e');
        $carpeta = storage_path();
