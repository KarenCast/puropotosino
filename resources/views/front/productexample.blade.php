...
@section('content')
    ...
    <style media="screen">
        ...
        .contenedor-redes-sociales .gplus2:hover,
        .contenedor-redes-sociales .gplus2:hover span.circulo {
        ...
        .contenedor-redes-sociales .gplus2:hover span.circulo,
        .contenedor-redes-sociales .gplus2 span.titulo {
                        ...
                        <div class="row align">
                            <div class="col-md-6">
                                <div class="container-fluid">
                                    ...
                                    <input type="text" name="totalpa" id="totalpa" value="{{ $totales }}"
                                        style="display: none">
                                </div>
                                ...
                                <div class="dropdown mr-1 ml-md-auto" style="width: 100%;">
                                    ...
                                    <button type="button" class="btn btn-white btn-sm dropdown" style="width: 100%">
                                        ...
                                        <a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown"
                                            style="width: 100%; color: rgb(92, 92, 92);">
                                            Nombre
                                        </a>
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <div class="site-block-27" id="numeros" style="display: none;">
                                    <ul>
                                        <li><a onclick="backPage()" href="#">&lt;</a></li>
                                        @for ($i = 1; $i <= $totales; $i++)
                                            <li class="itemPagination" value="{{ $i }}"
                                                onclick="showperpage({{ $i }});" id="page{{ $i }}">
                                                <a class="" href="#">{{ $i }}</a>
                                            </li>
                                        @endfor
                                        <li><a onclick="nextPage()" href="#">&gt;</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 order-1 order-lg-2 mb-5 mb-lg-0">
                        <div class="border mb-4">
                            ...
                            <ul class="list-unstyled mb-0">
                                <li class="mb-1 lines "><a href="javascript:void(0);" onclick="loadProducts(-1, 0)"
                                        class="d-flex">
                                        <span>Todas</span><span class="text-black ml-auto">({{ $total }})</span></a>
                                </li>
                                @foreach ($cat as $rol)
                                    <li class="mb-1 lines"><a href="javascript:void(0);"
                                            onclick="loadProducts({{ $rol->ID_categoria }}, 0)" class="d-flex">
                                            <span>{{ $rol->nombre }}</span>
                                            <span
                                                class="text-black ml-auto">({{ $number[$rol->ID_categoria] }})</span></a>
                                    </li>
                                @endforeach
                            </ul>
                        </div>
    ...
    <div class="modal fade" id="modalverproducto" tabindex="-1" role="dialog" aria-labelledby="modal-lici"
        aria-hidden="true">
                        ...
                        <form action="" method="post" id="candvac">
                            ...
                            <div class="row " style="border-top: 1px solid #ddd; padding:2em;">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea name="desc_e" id="desc_e" rows="3" cols="80" class="form-control" readonly
                                        style="border:none"></textarea>
                                </div>
                                <div class="form-group col-md-5">
                                    <p><strong>Marca registrada:</strong></p>
                                    <input readonly type="text" name="marca_e" id="marca_e"
                                        class="inoborder form-control" />
                                </div>
                                <div class="form-group col-md-5">
                                    <p><strong>Empresa:</strong></p>
                                    <input readonly type="text" name="empresa_e" id="empresa_e"
                                        class="inoborder form-control" />
                                </div>
    ...
    <script type="text/javascript">
        const idCategoriaSelect = {!! json_encode($idCategoriaSelect) !!};
