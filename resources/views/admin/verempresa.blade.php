                    ...
                    <div class="panel-body proceso">
                        ...
                        <form action="{{ route('empresa') }}" method="POST" enctype="multipart/form-data" role="form"
                            ...
                            <div class="form-group col-sm-12">
                                ...
                                <input type="text" class="form-control" disabled name="razon_social" id="razon_social" value="{{$rol->razon_social}}"></input>
                            </div>
                            <div class="form-group col-sm-12">
                                <label class="">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                @if($rol->RFC!=null)
                                <a href="../../link/{{$rol->RFC}}/{{$rol->comprobante_domicilio}}">
                                    <h4>Comprobante de domicilio</h4>
                                </a>

                                @else
                                <a href="../../link/{{$rol->CURP}}/{{$rol->comprobante_domicilio}}">
                                    <h4>Comprobante de domicilio</h4>
                                </a>
                            ...
                            <div class="form-group col-sm-6" style="text-align: center; padding-top: 3em;">
                                <a href="../../consultaMarcaspe/{{$rol->ID_empresa}}">
                                    <button class="btn btn-info" type="button" name="button">VER REGISTROS DE
                                        MARCA</button>
                                </a>
                            </div>
                            <div class="form-group col-sm-6" style="text-align: center; padding-top: 3em;">
                        ...
                        <form action="{{ route('enviarcorreo') }}" method="POST" enctype="multipart/form-data"
                            role="form" class="row smart-wizard form-horizontal" id="form" name="form" class="row">
                            {!! csrf_field() !!}
                            <input type="text" name="id" id="id" value="{{$rol->ID_empresa}}" style="display: none">
                            <div class="form-group col-sm-12">
                                <label class="">
                                    Escribe tus comentarios/observaciones que serán enviados por correo al usuario<span
                                        class="symbol required"></span>
                                </label>
                                <textarea required name="mensaje" id="mensaje" rows="8" cols="80"
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <select class="form-control" name="fase" id="fase">
                                    @if($rol->fase>=10)
                                    @for ($i = 10; $i < 17; $i++) {{$j = $i-10}} @if($rol->fase== $i )
                                        ...
                                        @endif
                                        @endfor
                                        @elseif($rol->fase<=10) @for ($i=0; $i < 7; $i++) @if($rol->fase== $i )
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <input type="submit" name="enviar" class="btn btn-primary"
                                    value="Guardar Fase y enviar comentarios">
                            </div>
                        </form>
                        @endforeach
                    </div>
