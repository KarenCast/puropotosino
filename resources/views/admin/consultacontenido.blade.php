						...
						<div class="col-sm-6">
							<ul class="list-group list-group-flush">
								<li class="list-group-item">
									 ...
									 <label class="switch ">
										 <input type="checkbox" class="primary" value="0" id="activas" name="activas" onchange="getCont();">
					...
					<div class="row">
						<div class="table-responsive">
						   <input type="text" name="tipoini" id="tipoini" style="display:none;" value="{{{session('tipoinicio')}}}">
							 <table id="tableconte" name= "tableconte" class="table-striped dt-responsive nowrap" style="width: 100%; ">
