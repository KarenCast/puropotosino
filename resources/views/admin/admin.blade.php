						...
						<div class="col-sm-6">
							<ul class="list-group list-group-flush">
								<li class="list-group-item">
									 ...
									 <label class="switch ">
										 <input type="checkbox" class="primary" value="0" id="activas" name="activas" onchange="getEmpresas();">
					...
					<div class="row">
						<div class="table-responsive">
						   <input type="text" name="tipoini" id="tipoini" style="display:none;" value="{{{session('tipoinicio')}}}">
							 <table id="tableemp" name= "tableemp" class="table-striped dt-responsive nowrap" style="width: 100%; ">
...
<!-- "ID_empresa", "RFC_camara", url_bolsa, correo_contacto, nombre_empresa,  -->
			...
			<div class="modal fade" id="modaleliminarvac" tabindex="-1" role="dialog" aria-labelledby="modal-lici" aria-hidden="true">
                                   ...
                                   <form action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row" style="border-top: 1px solid #ddd;">
                                             <div class="form-group col-md-12">
                                                  ...
                                                  <input style="width: 100%; text-align:center;"readonly style="text-align: center" required class="inoborder" type="text" name="id_emp" id="id_emp" data-rule="required"  placeholder=""  data-msg="Verifica que este campo no esté vacio y contenga informción correcta"/>
                                                  <div class="validation"></div>
                                             </div>

                                             <div class="form-group col-md-12">
                                                  <input style="width: 100%; text-align: center" readonly style="text-align: center" required  class="inoborder" type="text" name="desc_e" id="desc_e" data-rule="required"  placeholder="" data-msg="Verifica que este campo no esté vacio y contenga informción correcta"/>
                                                  <div class="validation"></div>
                                             </div>
                                        </div>
		                              ...
		                              <div class="container">
		                                   <form action="" method="post" enctype="multipart/form-data">
		                                        ...
		                                        <div class="row" style="border-top: 1px solid #ddd;">
		                                             <div class="form-group col-md-12">
		                                                  <p style="text-align: center"><strong>Vacante:</strong></p>
		                                                  <input style="width: 100%; text-align:center;"readonly style="text-align: center" required class="inoborder" type="text" name="id_vac" id="id_vac" data-rule="required"  placeholder=""  data-msg="Verifica que este campo no esté vacio y contenga informción correcta"/>
		                                                  <div class="validation"></div>
		                                             </div>

		                                             <div class="form-group col-md-12">
		                                                  <input style="width: 100%; text-align: center" readonly style="text-align: center" required  class="inoborder" type="text" name="desc_v" id="desc_v" data-rule="required"  placeholder="" data-msg="Verifica que este campo no esté vacio y contenga informción correcta"/>
		                                                  <div class="validation"></div>
		                                             </div>
		                                        </div>
		                                        <button style="text-align: center; width: 100%;" type="submit" class="btn btn-primary btn-lg btn-block login-btn">Aceptar</button>
