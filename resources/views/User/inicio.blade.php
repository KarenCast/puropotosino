                      ...
                      <ul>
												...
												<li>
													...
													@endif
														...
														<span class="stepDesc">
															<small>Imagen e identidad</small>
														</span>
													</a>
												</li>
												<li>
												...
												<li>
													...
													@endif
														...
														<span class="stepDesc">
															<small>Exporta y promocionate</small>
														</span>
													</a>
												</li>
												<li>
													...
													@endif
														...
														<span class="stepDesc">
															<small>Evoluciona tú negocio</small>
														</span>
													</a>
												</li>
											</ul>
											...
											@endif
												...
												<div class="col-md-12">
													<h1 style="margin-bottom: 2em;">Etapa 1: <span style="font-weight: 200;">Desarrolla tú idea de negocio</span></h1>
													<form action="{{ route('etapauno') }}" method="POST" enctype="multipart/form-data" role="form" class="row smart-wizard form-horizontal" id="form" name="form">
														...
														<div class="form-group col-sm-12" id="tipo_incu">
															<label class="">
											...
											@endif
											<h1 style="margin-bottom: 2em;">Etapa 2: <span style="font-weight: 200;">Dar de alta en SHCP</span></h1>
											<form action="{{ route('etapados') }}" method="POST" enctype="multipart/form-data" role="form" class="row smart-wizard form-horizontal" id="form" name="form">
												 {!! csrf_field() !!}
													<div class="form-group col-sm-6">
														<label class="">
															Alta hacienda (Constancia de situación fiscal - Archivo .pdf)<span class="symbol required"></span>
														</label>
													...
													<div class="form-group col-sm-12">
														...
														@if($emp->RFC!=null)
														<input type="text" readonly required class="form-control" id="rfc" name="rfc" placeholder="" value="{{$emp->RFC}}">
														@else
										...
										@endif
											<h1 style="margin-bottom: 2em;">Etapa 3: <span style="font-weight: 200;">Genera imagen e identidad de tu negocio</span></h1>
											<h3><strong>IMPORTANTE:<strong> Necesitas ya tener cargados tus productos y marcas</h3>
											<br>
											...
											<form action="{{ route('etapatres') }}" method="POST" enctype="multipart/form-data" role="form" class="row smart-wizard form-horizontal" id="form" name="form">
											    ...
											    <label class="">
												 ...
												 <div class="form-group col-md-6" id="tipo_incu">
												    <label class="">
											...
											<form action="{{ route('etapacinco') }}" method="POST" enctype="multipart/form-data" role="form" class="row smart-wizard form-horizontal" id="form" name="form">
												...
												<div class="form-group col-sm-12">
													<label class="">
														Carga comprobante de exportación (Solo para empresas que hayan exportado. Máximo 2MB, archivo .pdf)<br>
													</label>
													@if($emp->comprobante_exportacion!=null)
													<input type="file" name="compexp" id="compexp" class="form-control" accept="application/pdf"><br>
													<a href="./link/{{$emp->ID_empresa}}/{{$emp->comprobante_exportacion}}" target="_blank"> <h4>Comprobante actual</h4> </a>
													@else
													<input type="file" required name="compexp" id="compexp" class="form-control" accept="application/pdf"><br>
													@endif
												</div>
												<div class="form-group col-sm-12" id="guardaretapa">
													<label for=""></label><br>
											...
											@endif
													<div class="col-md-12">
														...
														<h3>Esta es la ultima etapa del proceso. ¡Felicidades, tu negocio esta en proceso de evolución!.<br></h3><br>
