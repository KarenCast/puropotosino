								...
								<div class="panel-body proceso">
									<form action="{{ route('umarca') }}" method="POST" enctype="multipart/form-data" role="form" class="row smart-wizard form-horizontal" id="form" name="form" class="row">
									  ...
									  <div class="form-group col-sm-6">
									    ...
									    <input required type="text" required class="form-control" id="nombre_marca" name="nombre_marca" placeholder="" value="{{$marcas->nombre_marca}}" onkeyup="mayus(this);">
									  </div>
									  <div class="form-group col-sm-6">
									    <label class="">
									      Comprobante de registro de marca (Máximo 2MB, archivo .PDF)<span class="symbol required"></span>
